import { IProductCart, IProduct } from "@/interfaces/IProduct"
...
export const { addProduct, increaseQuantityProduct, decreaseQuantityProduct, removeProductFromCart } = cartSlice.actions	
